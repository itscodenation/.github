...
| -----------------------   | ----------------------------  |
| <div style="width:300px">[Intro to Web Development](https://github.com/itscodenation/curriculum-22-23/tree/main/INTRO)</div> | <div style="width:400px">The focus of this course is **Exposure**. In this course, students are introduced to HTML, CSS and JavaScript. By the end of the course, students will be able to make simple webpages that involve fundamental JavaScript concepts.</div> |
